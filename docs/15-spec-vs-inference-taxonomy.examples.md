...
| 3 | Input TPM per PTU for `gpt-5.2` = 3,400 (synthetic) | OFFICIAL_SPEC | Cited from Microsoft Learn — provisioned-throughput-onboarding table (accessed 2026-05-28); URL: https://learn.microsoft.com/azure/ai-services/openai/how-to/provisioned-throughput-onboarding |
...
| 8 | Native spillover is reactive (per-request, stateless on caller) | OFFICIAL_SPEC | Cited from Microsoft Learn — spillover traffic management (accessed 2026-05-28); URL: https://learn.microsoft.com/azure/ai-services/openai/how-to/spillover-traffic-management |
